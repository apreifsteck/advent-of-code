defmodule AdventOfCode.Solutions.Y2023.S8 do
use AdventOfCode.Solution, use_prior_solution: true
  ...
  def solve!(data) do
    ...
    |> Enum.reverse()
    |> Enum.with_index()
    |> Enum.reduce(%{}, fn {num_matches, index}, cards_for_card -> 
      Map.put_new(cards_for_card, index, get_num_cards(num_matches, index, cards_for_card) + 1)
    end)
    |> Map.values()
    |> Enum.sum()
  end
